...
c0 = st.slider('c0', 0.0, 1.0, 0.5, 0.01)
c1 = st.slider('c1', 0.0, 1.0, 0.5, 0.01)
c2 = st.slider('c2', 0.0, 1.0, 0.5, 0.01)
c3 = st.slider('c3', 0.0, 1.0, 0.5, 0.01)
c4 = st.slider('c4', 0.0, 1.0, 0.5, 0.01)
c5 = st.slider('c5', 00.0, 1.0, 0.5, 0.01)
c6 = st.slider('c6', 0.0, 1.0, 0.5, 0.01)
c7 = st.slider('c7', 0.0, 1.0, 0.5, 0.01)
c8 = st.slider('c8', 0.0, 1.0, 0.5, 0.01)
